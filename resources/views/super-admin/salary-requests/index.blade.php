<x-layouts.app>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-6">
            <h1 class="text-2xl font-semibold">Salary Requests Management</h1>
        </div>

        <!-- Filters -->
        <div class="bg-white rounded-lg shadow p-6 mb-6">
            <form action="{{ route('super-admin.salary-requests') }}" method="GET" class="space-y-4">
                ...
                <div class="flex justify-between">
                    ...
                    <a href="{{ route('super-admin.salary-requests.export') }}"
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                @foreach($requests as $request)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">{{ $request->payment_method }}</td>
    ...
    @push('scripts')
        <script>
            ...
            document.getElementById('updateForm').addEventListener('submit', function(e) {
                ...
                fetch(`/super-admin/salary-requests/${currentRequestId}`, {
                    method: 'PUT',
                    headers: {
